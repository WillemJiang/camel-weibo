...
public class PublicConsumer extends Weibo4JPuller {

    public PublicConsumer(WeiboEndpoint we) {
        super(we);
    }
    ...
    public List<Status> pollStatus(long lastId) throws WeiboException {
        ...
        // Weibo4J doesn't provide the user time line by page
        StatusWapper result = timeline.getPublicTimeline();
